		...
		if ($this->controller->beforeScaffold($action)) {
			...
			if (!empty($request->data)) {
				...
				if ($this->_validSession) {
					$this->controller->Session->setFlash('Please correct errors below.', 'default', array('class' => 'flash_error'));
				}
			}
 ...
 */
	protected function _sendMessage($message) {
		if ($this->_validSession) {
			$this->controller->Session->setFlash($message, 'default', array('class' => 'flash_success'));
			return $this->controller->redirect($this->redirect);
		}
		$this->controller->flash($message, $this->redirect, array('class' => 'flash_error'));
	}
