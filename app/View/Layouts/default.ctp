...
$cakeDescription = __d('A sample CakePHP application', 'CakePHP 2.4.6');
?>
	...
	<div id="container">
		<div id="header">
			...
			<div style="float:right">
				...
				<h3 style="float:right;margin:0 5px">|</h3>
				<h3 style="float:right"><?php echo $this->Html->link('Articles',array('controller'=>'admin', 'action'=>'articles')); ?></h3>
				<?php if($this->session->read('Auth.User.name')) { ?>
				<br/>
		...
		<div id="footer">
			Copyright &copy; 2009-2014 Andolasoft. All rights reserved.
		</div>
	</div>
