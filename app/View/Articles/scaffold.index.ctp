        ...
        <div class="panel-heading"><h3><span class="glyphicon glyphicon-list-alt"></span> <?php echo $pluralHumanName; ?>
                <div class="btn-group pull-right">
                    ...
                    <ul class="dropdown-menu" role="menu">
                        <li>   
                           <?php 
							echo $this->Html->link(__d('cake', '<span class="glyphicon glyphicon-plus-sign"></span> Create %s', $singularHumanName), array('action' => 'add'), array('escape' => false)); ?>
                        </li>
                        <?php
                        $done = array();
						
						####### Comment Below Section to Hide the link of other Models ###########
